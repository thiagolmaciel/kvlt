...
import { ExternalLink, Code2, Briefcase, Users, Brain } from "lucide-react";
    ...
    <div className="flex flex-col gap-8">
      <Card className="border-primary/25 bg-primary/[0.05]">
        <CardContent className="p-5 flex flex-col gap-2.5">
          <div className="text-[13px] font-semibold uppercase tracking-wide text-accent-vivid">
            Snapshot atual
          </div>
          <p className="text-[15px] leading-relaxed">{roadmap.currentSnapshot}</p>
          <div className="mt-1 text-[14px] leading-relaxed text-muted-foreground italic">
            {roadmap.philosophy}
          </div>
        </CardContent>
      </Card>

      <div className="relative flex flex-col gap-10 pl-7 before:absolute before:left-[9px] before:top-3 before:bottom-3 before:w-px before:bg-border">
